...
<body>
  <header>
    <nav class="navigation_header">
      ...
      <div class="lien_page">
        ...
        <a href="catalogue.html"><i class="fas fa-book interactive"></i> Catalogue</a>
        <a href="enchere.html"><i class="fas fa-gavel interactive"></i> Enchère</a>
  ...
  <script src="/stampee/mvc/public/assets/js/modal-login.js"></script>
