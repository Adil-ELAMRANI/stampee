...
<html lang="fr">
  <head>
    ...
    <title>Enchère Timbre - Roumélie Orientale</title>
    <link
      rel="stylesheet"
  ...
  <body>
    <header>
      <nav class="navigation_header">
        <img
          class="logo"
          src="../../public/assets/logosStampee/logo-2.png"
          alt="Logo Stampee"
        />
        <div class="lien_page">
          <a href="index.html"
            ><i class="fas fa-home interactive"></i> Accueil</a
          >
    ...
    <section class="hero-banner-enchere">
      <h1>Informations sur le Timbre</h1>
    </section>

    <div class="main-enchere">
      <div class="miser-sur-un-timbre">
        <div class="image-contain">
          <img
            class="image"
            src="../../public/assets/img/turkey-stamp-66-eastern-rumelia-1886.jpg"
            alt="Timbre Roumélie Orientale 1886"
          />
        </div>
        <div class="text">
          <h2>Détails du Timbre</h2>
          <p class="p-enchere-rare">
            Timbre de 1886 de la Roumélie Orientale sous l'Empire Ottoman
          </p>
          <div>
            <p>Produit # 401425118</p>
            <p>Valeur faciale : 5 Paras</p>
            <p>Enchère en cours : 150$</p>
          </div>
          <div class="bouton-timbre">
            <button class="bouton-miser-enchere">Miser</button>
            <a href="#" class="info">Plus d’informations</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="footer-container">
        <div class="footer-content">
          <div class="footer-logo">
            <img src="../../public/assets/logosStampee/logo-2.png" alt="Logo" />
          </div>
